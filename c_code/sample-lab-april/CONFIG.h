...
#define FILE_NAME "multtest.csv" //KEEP THIS AT OR UNDER 8 CHARACTERS, not including '.csv' extension
...
constexpr time_t START_HOUR {9};   // set the hours start time (0-23)
constexpr time_t START_MIN {26};   // set the minutes start time (0-59)
