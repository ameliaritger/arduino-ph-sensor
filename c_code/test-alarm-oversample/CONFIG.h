...
#define FILE_NAME "0402_256.csv" //KEEP THIS AT OR UNDER 8 CHARACTERS, not including '.csv' extension
...
#define ADS1015_GAIN_VAL GAIN_SIXTEEN   // Recommended: GAIN_ONE
#define ADS1015_GAIN_MULT 0.125             // Change this number based on gain selected.
