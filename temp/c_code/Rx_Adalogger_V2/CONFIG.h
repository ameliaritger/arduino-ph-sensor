...
#define FILE_NAME "0127.csv" //KEEP THIS AT OR UNDER 8 CHARACTERS, not including '.csv' extension

constexpr time_t ALARM_INTERVAL {20};   // alarm interval (in seconds)
constexpr time_t START_DAY {27};   // set the starting day of the month (1-31)
constexpr time_t START_HOUR {19};   // set the hours start time (0-23)
constexpr time_t START_MIN {2};   // set the minutes start time (0-59)
