...
constexpr time_t START_DAY {22};   // set the day of the month start time (1-31)
constexpr time_t START_HOUR {15};   // set the hours start time (0-23)
constexpr time_t START_MIN {02};   // set the minutes start time (0-59)
