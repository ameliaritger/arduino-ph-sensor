...
int loopCount = 0; // create count variable to set number of times to loop
...
void loop()
{
  ...
  if (alarmTrigger && rtc.alarm(DS3232RTC::ALARM_1) && loopCount < 265) { // check alarm flag (and clear the flag if set)
    time_t t = rtc.get(); // get the current time
    formatTime(timestamp, t);
