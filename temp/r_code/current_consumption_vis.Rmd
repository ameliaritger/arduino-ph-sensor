...
ggplot(all_list, aes(x=time_adjust, y=current_ma)) +
  ...
  #annotate(geom = "point", x = 5.459331, y = 15.447820, colour = "#0072B2", size = 3) +
...
ggsave(here("temp", "figures", "OCEANS", "power_jan28.png"), height=10, width=30, units="cm")
```
