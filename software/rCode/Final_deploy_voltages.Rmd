...
file_names <- list.files(here("data", "raw", "deploy"), pattern = "CLEAN", recursive = FALSE, full.names = TRUE)
...
ggplot(merged, aes(x=date_time)) +
  geom_line(aes(y=v4corr, color=logger),size=1) +
...
#ggsave(here("figures", "final", "temp-deploy.png"), height=10, width=15, units="cm")
```
