...
```{r}
#Run the code
trisdata <- read_csv(here("data", "raw", paste(filename_tris,".csv",sep=""))) %>% # read in tris data excel file
...
#Write out .csv files
write.csv(omegas_ph_tris, here("data", "calibrated", paste(filename_tris,"_omegas.csv", sep="")),row.names = FALSE) # create csv with calibrated values
write.csv(calibration_values, here("data", "calibrated", paste(filename_tris,"_omegas_calib.csv", sep="")),row.names=FALSE)
```

## Run +1 tolerance calibration for Madgetech tris
```{r}
#Run the code
trisdata <- read_csv(here("data", "raw", paste(filename_tris,".csv",sep=""))) %>% # read in tris data excel file
  filter(row_number()!=c(1:5)) %>% # remove the first 5 rows
...
#Write out .csv files
write.csv(omegas_ph_tris, here("data", "calibrated", paste(filename_tris,"_omegas_plus1.csv", sep="")),row.names = FALSE) # create csv with calibrated values
write.csv(calibration_values, here("data", "calibrated", paste(filename_tris,"_omegas_plus1_calib.csv", sep="")),row.names=FALSE)
```
...
#Write out .csv files
write.csv(omegas_ph_tris, here("data", "calibrated", paste(filename_tris,"_omegas_minus1.csv", sep="")),row.names = FALSE) # create csv with calibrated values
write.csv(calibration_values, here("data", "calibrated", paste(filename_tris,"_omegas_minus1_calib.csv", sep="")),row.names=FALSE)
```
